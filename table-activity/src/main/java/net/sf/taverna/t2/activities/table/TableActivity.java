 ...
 * These are defined together in a TableActivityConfigurationBean, 
 * which includes a superclass of a AbstractProcessBean and can include a superclass of AbstractPreProcessBean.
 * <p>
 * Configuration is handled by the configure method 
 * which calls configureProcessPorts(AbstractProcessBean processBean),
...
*/
public class TableActivity extends AbstractAsynchronousActivity<TableActivityConfigurationBean> { 
    ...
    /**
     * This methods adds the input and output ports depending on the type of TableActivityConfigurationBean, and process and preprocess in includes.
     * 
     * <p>
     * The TableActivityConfigurationBean is checked for validity and then recorded so it can be accessed during execution.
     * <p>
     ...
     */
    @Override
    public final void configure(TableActivityConfigurationBean configBean) throws ActivityConfigurationException {
        ...
        AbstractProcessBean processBean = configBean.getProcess();
        ...
        AbstractInputsBean inputBean = processBean.getInputs();
    ...
    private List<String> prepareParameters(final Map<String, T2Reference> inputs, 
        ...
        AbstractPreProcessBean preProcessor = configBean.getPreprocess();
     ...
     */
    private List<String> createProcessParameters(AbstractProcessBean processBean,
     ...
     * @param inputBean 
     */
    private void configureInputPorts(AbstractInputsBean inputBean) {
     ...
     */
    private boolean addInputParameters(AbstractInputsBean inputBean, List<String> parameters,
            final Map<String, T2Reference> inputs, final AsynchronousActivityCallback callback) {
        if (inputBean instanceof SingleInputBean){
    ...
    private boolean addSingleInputParameters(SingleInputBean inputBean, List<String> parameters,
        ...
        TableInputType type = inputBean.retreiveStiltsInputType();
    ...
    private boolean addSingleFormatMultipleInputsParameters(SingleFormatMultipleInputsBean inputBean, List<String> parameters,
            final Map<String, T2Reference> inputs, final AsynchronousActivityCallback callback) {
        List<TableInputType> types = inputBean.getTypesOfInputs();
   ...
   //Support methods
    ...
    private final String getInputFilePath(final AsynchronousActivityCallback callback,
            TableInputType type, String input) {
        if (type == null){
