 ...
 * @author christian
 */
public enum TableJoin implements DescribableInterface{
    ...
    TableJoin(String stiltsName, String userName, String description){
    ...
    public static TableJoin byStiltsName(String stiltsName){
        for (TableJoin format:TableJoin.values()){
