...
public abstract class MultipleInputsBean1 extends StitlsInputsBean implements Serializable {
    ...
    protected MultipleInputsBean1(List<StiltsInputType> typesOfInputsEnum){
        this.typesOfInputsEnums = typesOfInputsEnum;
    }
      
    protected MultipleInputsBean1(){}
    ...
    public void resetTypesOfInputs(List<StiltsInputType> typesOfInput) {
        typesOfInputsEnums = typesOfInput;
    }
