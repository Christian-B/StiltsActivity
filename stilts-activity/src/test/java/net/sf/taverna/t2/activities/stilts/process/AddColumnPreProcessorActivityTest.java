...
public class AddColumnPreProcessorActivityTest {
    ...
    public void byCommand() throws Exception {
        ...
        AddColumnByCommandPreProcessorBean preProcessBean = new AddColumnByCommandPreProcessorBean("$1 + $3", null, "$2", "newCol");
    ...
    public void minus() throws Exception {
        ...
        AddColumnTwoVariablesPreProcessorBean preProcessBean = 
                new AddColumnTwoVariablesPreProcessorBean(StiltsTwoVariableOperator.MINUS, "$3","id", "name", null, "newCol");
        configBean.setPreprocess(preProcessBean);
    ...
    public void max() throws Exception {
        ...
        AddColumnTwoVariablesPreProcessorBean preProcessBean = 
                new AddColumnTwoVariablesPreProcessorBean(StiltsTwoVariableOperator.MAX, "$3","id", null, null, "newCol");
        configBean.setPreprocess(preProcessBean);
    ...
    public void convertToFloat() throws Exception {
        ...
        AddColumnOneVariablesPreProcessorBean preProcessBean = 
                new AddColumnOneVariablesPreProcessorBean(StiltsOneVariableOperator.FLOAT, "$3", null, null, "newCol");
        configBean.setPreprocess(preProcessBean);
        String expected = "id,name,number,newCol" + System.lineSeparator() +
    ...
    public void roundup() throws Exception {
        ...
        AddColumnOneVariablesPreProcessorBean preProcessBean = 
                new AddColumnOneVariablesPreProcessorBean(StiltsOneVariableOperator.ROUNDUP, "(float)($3)/2.0", null, null, "newCol");
        configBean.setPreprocess(preProcessBean);
        String expected = "id,name,number,newCol" + System.lineSeparator() +
