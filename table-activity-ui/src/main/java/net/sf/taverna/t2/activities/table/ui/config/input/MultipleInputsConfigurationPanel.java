...
import net.sf.taverna.t2.activities.table.input.MultipleInputsBean;
...
public abstract class MultipleInputsConfigurationPanel<BoundedBean extends MultipleInputsBean> 
        extends TableInputConfigurationPanel<BoundedBean> implements DocumentListener{
 
    private List<JComboBox<TableInputType>> inputsTypesSelectors;
   ...
   void initGui() {
    ...
    void resetSelectors() {
        inputsTypesSelectors = new ArrayList<JComboBox<TableInputType>>();
    }
    ...
    void addTableRow(int i){
        ...
        JComboBox<TableInputType> box = new JComboBox<TableInputType>(TableInputType.values());
    ...
    public void noteConfiguration(){
        ArrayList<TableInputType> types = new ArrayList<TableInputType>();
        for (int i = 0; i < getNumberOfInputs(); i++){
            types.add((TableInputType)inputsTypesSelectors.get(i).getSelectedItem());
        }
