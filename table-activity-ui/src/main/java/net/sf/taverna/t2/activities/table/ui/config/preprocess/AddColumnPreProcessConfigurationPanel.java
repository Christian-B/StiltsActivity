...
import net.sf.taverna.t2.activities.table.ui.config.FunctionWizard;
...
public class AddColumnPreProcessConfigurationPanel extends TablePreProcessConfigurationPanel<AddColumnPreProcessorBean>{
 
    private final JComboBox<TableLocationType> locationTypeSelector;
    ...
    AddColumnPreProcessConfigurationPanel(AddColumnPreProcessorBean preprocessBean){
        ...
        locationTypeSelector = new JComboBox<TableLocationType>(TableLocationType.values());
    ...
    public boolean checkValues() {
        ...
        if (!locationTypeSelector.getSelectedItem().equals(TableLocationType.END)){
    ...
    public void noteConfiguration() {
        ...
        preprocessBean.setNewColumnLocation((TableLocationType)locationTypeSelector.getSelectedItem());
        if (preprocessBean.getNewColumnLocation().equals(TableLocationType.END)){
    ...
    private void updateOnLocationTypeSelector(){
        TableLocationType type = (TableLocationType)locationTypeSelector.getSelectedItem();
        switch (type){
            case AFTER:
